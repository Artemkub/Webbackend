...
-- Таблица администратора (логин и хеш пароля в отдельной таблице)
...
-- Языки программирования (если ещё не заполнены)
...
-- Первый администратор: логин admin, пароль admin (хеш = SHA256(salt+password) в hex)
INSERT IGNORE INTO admin (login, password_hash, salt) VALUES
('admin', LOWER(SHA2(CONCAT('initsalt16bytes!!', 'admin'), 256)), 'initsalt16bytes!!');
